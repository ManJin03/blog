...
// 悬停在可点击元素时，圆点放大高亮
const interactiveSel = 'a, button, .post, .comment, .side-link, .filter-chip, input, textarea, .works-card, .status-bar, .search-clear, .act-btn, .modal-close, .brand, .auth-btn, .user-avatar-btn, .btn-ghost, .publish-btn, .filter-select, .toast, .user-item';
